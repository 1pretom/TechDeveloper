...
//    }
    ...
    @Autowired //injeção de dependencia pra deixar de precisar instanciar
    //@Qualifier("") // informa de onde vai pegar a injeção de dependencia a fins de limitar a quantidade de funções
    ProdutoService service; //na classe precisa ser um bean informando o que ela é
