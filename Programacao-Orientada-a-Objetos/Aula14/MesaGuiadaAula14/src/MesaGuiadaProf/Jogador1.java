...
public class Jogador1 implements Comparable<Jogador1>{
    ...
    public Jogador1(int numeroCamisa, String nome, boolean lesionado, boolean titular) {
    ...
    @Override
    public int compareTo(Jogador1 o) {
